...
@section('title', 'Shop Details Two')
@section('content')
    <!-- ============================ header area ============================ -->
                                ...
                                <div class="product-details__thumb-slider border border-gray-100 rounded-16">
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                            <img src="{{asset('assets/images/thumbs/product-details-two-thumb1.png')}}" alt="img" />
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                            <img src="{{asset('assets/images/thumbs/product-details-two-thumb2.png')}}" alt="img" />
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                            <img src="{{asset('assets/images/thumbs/product-details-two-thumb3.png')}}" alt="img" />
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                    ...
                                    <div class="product-details__images-slider">
                                        <div>
                                            <div
                                                ...
                                                <img src="{{asset('assets/images/thumbs/product-details-two-thumb1.png')}}"
                                                    alt="img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div
                                                class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                                <img src="{{asset('assets/images/thumbs/product-details-two-thumb2.png')}}"
                                                    alt="img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div
                                                class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                                <img src="{{asset('assets/images/thumbs/product-details-two-thumb3.png')}}"
                                                    alt="img" />
                                            </div>
                                        </div>
                                        <div>
                        ...
                        <div class="col-xl-6">
                            <div class="product-details__content">
                                <div
                                    ...
                                    <img src="{{asset('assets/images/bg/details-offer-bg.png')}}" alt="img"
                                    ...
                                    <span class="text-white text-xs">Remains untill the end of the
                                        offer</span>
                                </div>

                                <h5 class="mb-12">
                                    HP Chromebook With Intel Celeron, 4GB
                                    Memory & 64GB eMMC - Modern Gray
                                </h5>
                                ...
                                <p class="text-gray-700">
                                    Geared up and ready to roll: Get the
                                    responsive performance you're looking
                                    for with an Intel processor and 64 GB
                                    eMMC storage. Stay productive with
                                    compatible apps like Microsoft Office,
                                    Google Workspace, and more. The Chrome
                                    OS gives you a fast, simple, and secure
                                    online experience with built-in virus
                                    protection.
                                </p>
                                    ...
                                    <div class="flex-between align-items-start flex-wrap gap-16">
                                        <div>
                                            ...
                                            <div class="color-list flex-align gap-8">
                                                <button type="button"
                                                    class="color-list__button w-20 h-20 border border-2 border-gray-50 rounded-circle bg-info-600"></button>
                                                <button type="button"
                                                    class="color-list__button w-20 h-20 border border-2 border-gray-50 rounded-circle bg-warning-600"></button>
                                                <button type="button"
                                                    class="color-list__button w-20 h-20 border border-2 border-gray-50 rounded-circle bg-tertiary-600"></button>
                                                <button type="button"
                                                    class="color-list__button w-20 h-20 border border-2 border-gray-50 rounded-circle bg-main-600"></button>
                                                <button type="button"
                                                    class="color-list__button w-20 h-20 border border-2 border-gray-50 rounded-circle bg-gray-100"></button>
                                            </div>
                                        </div>
                                        <div>
                                            <span class="text-gray-900 d-block mb-12">
                                ...
                                <div class="mt-32">
                                    ...
                                    <div class="mt-10">
                                        <img src="{{asset('assets/images/thumbs/gateway-img.png')}}" alt="img" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="product-details__sidebar py-40 px-32 border border-gray-100 rounded-16">
                        ...
                        <div class="mt-32">
                            <div class="px-16 py-8 bg-main-50 rounded-8 flex-between gap-24 mb-14">
                                ...
                                <span class="text-sm text-neutral-600">Ship from
                                    <span class="fw-semibold">MarketPro</span>
                                </span>
                            </div>
                            <div class="px-16 py-8 bg-main-50 rounded-8 flex-between gap-24 mb-0">
                                ...
                                <span class="text-sm text-neutral-600">Sold by:
                ...
                <div class="product-dContent border rounded-24">
                    <div class="product-dContent__header border-bottom border-gray-100 flex-between flex-wrap gap-16">
                        ...
                        <a href="#"
                            ...
                            <img src="{{asset('assets/images/icon/satisfaction-icon.png')}}" alt="img" />
                            ...
                            <div class="tab-pane fade show active" id="pills-description" role="tabpanel"
                                ...
                                <div class="mb-40">
                                    ...
                                    <p>
                                        ...
                                        happen, the LAY'S brand will be
                                        there just as it has been for more
                                        than 75 years. With flavors almost
                                        as rich as our history, we have a
                                        chip or crisp flavor guaranteed to
                                    ...
                                    <p>
                                        ...
                                        Maecenas lacus odio, feugiat eu nunc
                                        sit amet, maximus sagittis dolor.
                                        Vivamus nisi sapien, elementum sit
                                        amet eros sit amet, ultricies cursus
                                        ipsum. Sed consequat luctus ligula.
                                        Curabitur laoreet rhoncus blandit.
                                        Aenean vel diam ut arcu pharetra
                                        dignissim ut sed leo. Vivamus
                                        faucibus, ipsum in vestibulum
                                        vulputate, lorem orci convallis
                                        quam, sit amet consequat nulla felis
                                        pharetra lacus. Duis semper erat
                                        mauris, sed egestas purus commodo
                                        vel.
                                    </p>
                                    <ul class="list-inside mt-32 ms-16">
                                        <li class="text-gray-400 mb-4">
                                            8.0 oz. bag of LAY'S Classic
                                            Potato Chips
                                        </li>
                                        <li class="text-gray-400 mb-4">
                                            Tasty LAY's potato chips are a
                                            great snack
                                        </li>
                                        <li class="text-gray-400 mb-4">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mt-56">
                                            <div class="">
                                                ...
                                                <span class="text-heading mb-8">What is it like to
                                                    Product?</span>
                                                <div class="flex-align gap-8">
                                                    <span class="text-xs fw-medium text-warning-600 d-flex"><i
                                                            class="ph-fill ph-star"></i></span>
    ...
    It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</textarea>
                                                    ...
                                                    <button type="submit" class="btn btn-main rounded-pill mt-48">
                                                        Submit Review
                                                    </button>
                                                </form>
                                            </div>
                                        ...
                                        <div class="ms-xxl-5">
                                            ...
                                            <div class="d-flex flex-wrap gap-44">
                                                <div
                                                    ...
                                                    <span class="mt-16 text-gray-500">Average Product
                                                        Rating</span>
                                                </div>
            ...
            <div class="new-arrival__slider arrow-style-two">
                    ...
                    <div
                        ...
                        <div class="product-card__content p-sm-2 w-100">
                            <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                <a href="{{route('shop.details')}}" class="link text-line-2">C-500 Antioxidant Protect Dietary
                                    Supplement</a>
                            </h6>
                            <div class="flex-align gap-4">
                ...
                <div>
                    <div
                        ...
                        <div class="product-card__content p-sm-2 w-100">
                            <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                <a href="{{route('shop.details')}}" class="link text-line-2">Marcel's Modern Pantry Almond
                                    Unsweetened</a>
                            </h6>
                            <div class="flex-align gap-4">
                                <span class="text-main-600 text-md d-flex"><i class="ph-fill ph-storefront"></i></span>
                ...
                <div>
                    <div
                        ...
                        <div class="product-card__content p-sm-2 w-100">
                            <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                <a href="{{route('shop.details')}}" class="link text-line-2">O Organics Milk, Whole, Vitamin
                                    D</a>
                            </h6>
                            <div class="flex-align gap-4">
                                <span class="text-main-600 text-md d-flex"><i class="ph-fill ph-storefront"></i></span>
                ...
                <div>
                    <div
                        ...
                        <div class="product-card__content p-sm-2 w-100">
                            <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                <a href="{{route('shop.details')}}" class="link text-line-2">Whole Grains and Seeds Organic
                                    Bread</a>
                            </h6>
                            <div class="flex-align gap-4">
                                <span class="text-main-600 text-md d-flex"><i class="ph-fill ph-storefront"></i></span>
                ...
                <div>
                    <div
                        ...
                        <div class="product-card__content p-sm-2 w-100">
                            <h6 class="title text-lg fw-semibold mt-12 mb-8">
                                <a href="{{route('shop.details')}}" class="link text-line-2">Nature Valley Whole Grain Oats and
                                    Honey Protein</a>
                            </h6>
                            <div class="flex-align gap-4">
                                <span class="text-main-600 text-md d-flex"><i class="ph-fill ph-storefront"></i></span>
