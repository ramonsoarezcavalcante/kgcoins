                                ...
                                <div class="product-details__thumb-slider border border-gray-100 rounded-16">
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                            <img src="{{asset('assets/images/thumbs/product-details-thumb1.png')}}" alt="img" />
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                            <img src="{{asset('assets/images/thumbs/product-details-thumb2.png')}}" alt="img" />
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                            <img src="{{asset('assets/images/thumbs/product-details-thumb3.png')}}" alt="img" />
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="product-details__thumb flex-center h-100">
                                    ...
                                    <div class="product-details__images-slider">
                                        <div>
                                            <div
                                                ...
                                                <img src="{{asset('assets/images/thumbs/product-details-img1.png')}}" alt="img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div
                                                class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                                <img src="{{asset('assets/images/thumbs/product-details-img2.png')}}" alt="img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div
                                                class="max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8">
                                                <img src="{{asset('assets/images/thumbs/product-details-img3.png')}}" alt="img" />
                                            </div>
                                        </div>
                                        <div>
                                            <div
                        ...
                        <div class="col-xl-6">
                            <div class="product-details__content">
                                ...
                                <p class="text-gray-700">
                                    ...
                                    tincidunt. Class aptent taciti sociosqu
                                    ad litora torquent
                                </p>
                                ...
                                <div class="flex-align flex-wrap gap-16 bg-color-one rounded-8 py-16 px-24">
                                    ...
                                    <span class="text-gray-900 text-xs">Remains untill the end of the
                                        offer</span>
                                </div>
                    ...
                    <div class="product-details__sidebar border border-gray-100 rounded-16 overflow-hidden">
                        ...
                        <div class="p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100">
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-700">
                                    Payment upon receipt of goods, Payment
                                    by card in the department, Google Pay,
                                    Online card.
                                </p>
                            </div>
                        </div>
                        <div class="p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100">
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-700">
                                    ...
                                    provide for the return of this product
                                    of proper quality.
                                </p>
                            </div>
                        </div>
                        <div class="p-24 bg-color-one d-flex align-items-start gap-24 border-bottom border-gray-100">
                            ...
                            <div class="">
                                ...
                                <p class="text-gray-700">
                                    Research & development value proposition
                                    graphical user interface investor.
                                </p>
                            </div>
                        </div>
                    </div>
